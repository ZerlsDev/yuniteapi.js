module.exports = {
    registrationData: require('./registrationData.js'),
    blockUser: require('./blockUser.js'),
    blockEpic: require('./blockEpic.js'),
    unblockUser: require('./unblockUser.js'),
    unblockEpic: require('./unblockEpic.js'),
    addPlayerToQueue: require('./addPlayerToQueue.js'),
